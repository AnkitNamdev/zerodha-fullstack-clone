...
function Footer() {
    return ( 
        <footer style={{backgroundColor:"rgp(250, 250,250"}}>
       <div className='container border-top mt-5'>
           ...
           <div className='col  mt-3 mb-3  d-flex justify-content-center gap-4'> 
               ...
               <a href='' style={{textDecoration:"none"}}>  Disclosure For investor's</a>
               <a href='' style={{textDecoration:"none"}}>  attention Investor</a>
               <a href='' style={{textDecoration:"none"}}> charter</a>                
           </div>
       </div>
       </footer>
     );
